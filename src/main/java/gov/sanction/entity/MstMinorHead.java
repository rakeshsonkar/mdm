...
@Data
@Entity
@Table(name="MST_MINOR_HEAD", schema ="MDM")
public class MstMinorHead {
	...
	@Column(name = "MINOR_HEAD_CODE", nullable = false)
	private String  minorHeadCode;
	
	@Column(name = "MINOR_HEAD_NAME_EN", nullable = false)
	private String  MinorHeadNameEn;
	@Column(name = "MINOR_HEAD_NAME_HI", nullable = false)
	private String  MinorHeadNameHi;
